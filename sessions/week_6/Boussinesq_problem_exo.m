...
right  % right side of the area

top          % top of the area (needed later)

%%All movements are restricted on the two boundaries. Remeber that we
...
amp_factor=1e5; % To highlight the displacements
...
Sp = ProjectStress_exo(mesh,'Axis',soil,u_res);
